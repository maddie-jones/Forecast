...
/***/ (function(module, exports, __webpack_require__) {
	...
	var deleteButton = document.getElementById("change-button");
	...
	function renderForecast(data) {
	  ...
	  var icon = data["data"]["attributes"]["currently"].icon;
	  var time = data["data"]["attributes"]["currently"].time;
	  var appTemp = data["data"]["attributes"]["currently"].apparentTemperature;
	  var humidity = data["data"]["attributes"]["currently"].humidity;
	  var visibility = data["data"]["attributes"]["currently"].visibility;
	  var uvIndex = data["data"]["attributes"]["currently"].uvIndex;
	  var actualTime = moment.unix(time);
	...
	function hourly(data) {
	  var hourly = data["data"]["attributes"]["hourly"]["data"];
	  var _iteratorNormalCompletion = true;
	  var _didIteratorError = false;
	  var _iteratorError = undefined;

	  try {
	    for (var _iterator = hourly[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	...
	function daily(data) {
	  var daily = data["data"]["attributes"]["daily"]["data"];
	  console.log(daily);
	  ...
	  try {
	    for (var _iterator2 = daily[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
